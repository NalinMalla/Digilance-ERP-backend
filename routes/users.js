...
router.route("/all").get([authJwt.verifyToken, authJwt.isAdmin],userController.findAllUsers);
...
// router.route("/lock/:eID").post([authJwt.verifyToken, authJwt.isAdmin, authJwt.accessGrant],userController.lockUserByID);
